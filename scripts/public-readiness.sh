...
if rg -n --hidden --glob '!.git/**' --glob '!LICENSE' \
  --glob '!scripts/public-readiness.sh' \
  'BEGIN (RSA|DSA|EC|OPENSSH|PGP|PR[I]VATE) K[E]Y|ghp_[A-Za-z0-9_]+|github_pat_[A-Za-z0-9_]+|xox[baprs]-|AKIA[0-9A-Z]{16}|oci[d]1\.' .; then
